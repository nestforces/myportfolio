...
const logos = [reactlogo, nodelogo, kotlinlogo];

const names = ["React", "Node", "Kotlin"];
              ...
              {logos.map((logo, index) => (
                <Box
                  ...
                  filter={`drop-shadow(0 0 5px ${
                    skillColors[names[index]] || "rgba(255, 255, 255, 0.5)"
                  })`}
                  key={index}
                  boxSize="100px"
                  margin="auto"
              ...
              {logos2.map((logo, index) => (
                ...
                >
                  <Image
                    ...
                    transform={`rotateY(${index * (360 / logos2.length)}deg) translateZ(120px) ${
