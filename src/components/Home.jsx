        ...
        <Box bgImage={computerjpg3} bgSize='cover'>
            <Flex pt='30px' pb='30px' bgColor='rgba(0, 0, 0, 0.7)' rowGap='50px' flexDirection={{base: 'column', md:'row', sm:'column'}}>
                <Box width={{base: '100%', md:'50%'}} textAlign='center'>
                    ...
                    <Button borderRadius='full' _hover={{bgColor: '#bc3876'}} variant='outline' colorScheme='blue' borderWidth='3px' fontWeight='bold' backgroundColor='white' onClick={() => window.open("https://drive.google.com/file/d/1p3Co3nXvtqcALZdPdKOSirvicEt1UBPg/view?usp=sharing", "_blank")} borderColor="linear(to-r, #b686e8, #bc3876)">
